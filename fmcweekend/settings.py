"""
Django settings for fmcweekend project.
...
SECRET_KEY = 'vfoph9ufyp@i!99^jyxf+$((oi5h8d5am@d#v+ovp)pagzmc@v'
...
WSGI_APPLICATION = 'fmcweekend.wsgi.application'
